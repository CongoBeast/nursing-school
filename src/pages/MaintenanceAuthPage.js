...
import { User, Lock, Mail, Phone, UserCheck, Wrench, Shield, Eye, EyeOff, Upload, Calendar, MapPin, Users, Building, AlertTriangle, AlertCircle, Info, Clock, Tool, HardHat } from 'lucide-react';
...
const MaintenanceAuthPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!isLogin) {
      ...
      if (!formData.staffId) {
        setError('Staff ID is required for maintenance crew');
        return false;
      }
    //   if (!formData.position) {
    //     setError('Please select your position/specialization');
    //     return false;
    //   }
    }
    return true;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.token) {
        ...
        if (backendUserType !== 'maintenance' && endpoint === "login") {
          setError(
            `This account is not registered as maintenance crew. 
            ...
            <Card style={customStyles.authCard}>
              ...
              <div style={customStyles.authHeader}>
                ...
                <p className="mb-4 opacity-90">
                  Parirenyatwa School of Nursing - Facilities Management
                </p>
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  {!isLogin && (
                    <Form.Group className="mb-4 text-center">
                      <Form.Label className="fw-medium d-block mb-2" style={{ color: '#15803D' }}>
                        Profile Picture
                      </Form.Label>
                      <div style={customStyles.avatarUpload} onClick={() => document.getElementById('avatar-input').click()}>
                        {avatarPreview ? (
                          ...
                          <Upload style={{ color: '#16A34A' }} size={24} />
                        )}
                      </div>
                      <Form.Control
                        id="avatar-input"
                  ...
                  {!isLogin && (
                    <>
                      ...
                      <Row className="mb-3">
                        {/* <Col md={6}>
                          <Form.Group className="position-relative">
                            <Wrench style={customStyles.inputIcon} size={18} />
                            <Form.Select
                              name="position"
                      ...
                      {/* Certifications */}
                      {/* <Form.Group className="mb-3 position-relative">
                        <HardHat style={customStyles.inputIcon} size={18} />
                        <Form.Control
                          as="textarea"
                          rows={2}
                          placeholder="Certifications (optional - e.g., Licensed Electrician, HVAC Certified, etc.)"
                          name="certifications"
                      ...
                      <Form.Group className="mb-3">
                        <Form.Label className="fw-medium mb-2" style={{ color: '#15803D' }}>
                          Emergency Contact
                        </Form.Label>
                        <Row>
                          <Col md={6}>
                  ...
                  <div className="text-center">
                    {isLogin ? (
                      <p className="small mb-0" style={{ color: '#16A34A' }}>
...
export default MaintenanceAuthPage;